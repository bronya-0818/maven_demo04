...
<div class="m-container-small m-padded-large">
    <div class="ui container">
        ...
        <div class="ui attached segment m-padded-large">
            <div class="ui labeled button m-margin-small" th:each="clazz:${clazzList}">
                <a href="#" class="ui basic button" th:text="${clazz.clazzName}" th:classappend="${clazz.id==clazzId}?'teal'" th:href="@{/type/list(clazzId=${clazz.id})}">思考与感悟</a>
                <div class="ui basic left pointing label" th:text="${clazz.postCount}" th:classappend="${clazz.id==clazzId}?'teal'">24</div>
            </div>
            <!--/*-->
            <div class="ui labeled button m-margin-small">
                <a href="#" class="ui basic teal button">java</a>
                <div class="ui basic teal left pointing label">23</div>
            </div>
            <div class="ui labeled button m-margin-small">
                <a href="#" class="ui basic button">python</a>
                <div class="ui basic left pointing label">7</div>
            </div>
            <div class="ui labeled button m-margin-small">
                <a href="#" class="ui basic button">c++</a>
                <div class="ui basic left pointing label">9</div>
            </div>
            <div class="ui labeled button m-margin-small">
                <a href="#" class="ui basic button">计算机网络</a>
                <div class="ui basic left pointing label">2</div>
            </div>
            <div class="ui labeled button m-margin-small">
                <a href="#" class="ui basic button">计算机组成原理</a>
                <div class="ui basic left pointing label">9</div>
            </div>
            <div class="ui labeled button m-margin-small">
                <a href="#" class="ui basic button">操作系统</a>
                <div class="ui basic left pointing label">15</div>
            </div>
            <div class="ui labeled button m-margin-small">
        ...
        <div class="ui top attached teal segment">
            <div class="ui padded segment vertical m-padded-big m-mobile-lr-clear" th:each="post:${postList}">
        ...
        <div class="ui bottom attached segment">
            <div class="ui middle aligned two column grid">
                <div class="column">
                    <a href="#" class="ui mini teal basic button" th:href="@{/type/list/(clazzId=${clazzId},pageNum=(${postList.pageNum}-1<1?1:${postList.pageNum}-1))}">上一页</a>
                </div>
                <div class="right aligned column">
                    <a href="#" class="ui mini teal basic button" th:href="@{/type/list/(clazzId=${clazzId},pageNum=(${postList.pageNum}+1>${postList.pages}?${postList.pages}:${postList.pageNum}+1))}">下一页</a>
                </div>
            </div>
        </div>
        <!-- 中间内容底部的翻页效果结束 -->
