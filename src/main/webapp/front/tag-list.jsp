...
<body>
<!-- 导航开始 -->
<nav th:replace="_fragments :: menu(3)" class="ui inverted attached segment m-padded-mini m-shadow-small">
...
<div class="m-container-small m-padded-large">
    <div class="ui container">
        ...
        <div class="ui attached segment m-padded-large">
            <a href="#" class="ui basic left pointing label m-padded-small" th:each="label:${labelList}" th:href="@{/tag/list(labelId=${label.id})}" th:classappend="${label.id==labelId}?'teal'">
                <span th:text="${label.labelName}">知识点</span>
                <div class="detail" th:text="${label.postCount}">23</div>
            </a>
            <!--/*-->
            <a href="#" class="ui teal basic left pointing large label m-margin-small">
                java
                <div class="detail">2</div>
            </a>
            <a href="#" class="ui basic left pointing large label m-margin-small">
                c++
                <div class="detail">122</div>
            </a>
            <a href="#" class="ui basic left pointing large label m-margin-small">
                python
                    ...
                    <div class="eleven wide column">
                        ...
                        <div class="ui stackable grid">
                            <div class="row">
                                ...
                                <!--       class="ui teal basic m-padded-all-mini m-text-thin label">学习笔记</a>-->
                                <!--</div>-->
                            </div>
                            <!--<div class="row">-->
                            <!--    <div class="column">-->
                            <!--        <a class="ui mini basic teal left pointing label m-padded-mini m-text-thin">知识点</a>-->
                            <!--    </div>-->
                            <!--</div>-->
                        </div>
                    </div>
        ...
        <div class="ui bottom attached segment">
            <div class="ui middle aligned two column grid">
                <div class="column">
                    <a href="#" class="ui mini teal basic button" th:href="@{/tag/list/(labelId=${labelId},pageNum=(${postList.pageNum}-1<1?1:${postList.pageNum}-1))}">上一页</a>
                </div>
                <div class="right aligned column">
                    <a href="#" class="ui mini teal basic button" th:href="@{/tag/list/(labelId=${labelId},pageNum=(${postList.pageNum}+1>${postList.pages}?${postList.pages}:${postList.pageNum}+1))}">下一页</a>
                </div>
            </div>
        </div>
        <!-- 中间内容底部的翻页效果结束 -->
