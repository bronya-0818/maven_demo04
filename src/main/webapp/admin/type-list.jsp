...
<div class="ui attached pointing menu">
    <div class="ui container">
        <div class="right menu">
            <a href="admin/type/list" class="active teal item">列表</a>
...
<div class="m-container-small m-padded-massive">
    <div class="ui container">
        ...
        <table class="ui celled table">
            ...
            <tbody>
            <c:forEach items="${clazzList.list}" var="clazz" varStatus="status">
                <tr th:each="clazz,iterStat : ${clazzList.list}">
                    <td>${status.count}</td>
                    <td>${clazz.clazzName}</td>
                    <td>
                        <a href="admin/type/edit/${clazz.id}"
                           class="ui mini teal basic button">编辑</a>
                        <a href="admin/type/delete/${clazz.id}"
            ...
            <tr>
                <th colspan="6">
                    <div class="ui mini pagination menu">
                        <a class="item"
                           th:href="@{/admin/type/list(pageNum=(${clazzList.pageNum}-1<1?1:${clazzList.pageNum}-1))}">上一页</a>
                        <a class="item"
                           th:href="@{/admin/type/list(pageNum=(${clazzList.pageNum}+1>${clazzList.pages}?${clazzList.pages}:${clazzList.pageNum}+1))}">下一页</a>
                    </div>
                    <a class="ui mini right floated teal basic button" th:href="@{/admin/type/add}">新增</a>
                </th>
            </tr>
            </tfoot>
            <!-- 中间内容分页结束 -->
