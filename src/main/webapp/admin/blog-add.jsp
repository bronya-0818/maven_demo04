...
<nav class="ui inverted attached segment m-padded-mini m-shadow-small">
    <div class="ui container">
        <div class="ui inverted secondary stackable menu">
            ...
            <a href="admin/clazz/list" class="m-item item m-mobile-hide"><i class="idea icon"></i>分类</a>
...
<div class="ui attached pointing menu">
    <div class="ui container">
        <div class="right menu">
            ...
            <a href="admin/blog/goAdd" class="active teal item">新增</a>
...
<div class="m-container m-padded-large">
    <div class="ui container">
        <form id="post-form" action="/admin/blog/doAdd" method="post" class="ui form" >
            ...
            <div class="required field">
                <textarea name="summary" th:text="${post.summary}" placeholder="博客描述..." maxlength="200"></textarea>
            </div>

            <div class="inline fields">
                <div class="field">
                    <div class="ui checkbox">
                        <input type="checkbox" id="recommendStatus" name="recommendStatus" class="hidden" checked="${post.recommendStatus}">
                        <label for="recommendStatus">推荐</label>
                    </div>
                </div>
                <div class="field">
                    <div class="ui checkbox">
                        <input type="checkbox" id="rewardStatus" name="rewardStatus" class="hidden" checked="${post.rewardStatus}">
                        <label for="rewardStatus">打赏</label>
                    </div>
                </div>
                <div class="field">
                    <div class="ui checkbox">
                        <input type="checkbox" id="copyrightStatus" name="copyrightStatus" class="hidden" checked="${post.copyrightStatus}">
                        <label for="copyrightStatus">版权</label>
                    </div>
                </div>
                <div class="field">
                    <div class="ui checkbox">
                        <input type="checkbox" id="commentStatus" name="commentStatus" class="hidden" checked="${post.commentStatus}">
